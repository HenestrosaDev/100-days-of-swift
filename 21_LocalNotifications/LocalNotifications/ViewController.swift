...
class ViewController: UIViewController, UNUserNotificationCenterDelegate {
    ...
    @objc func scheduleLocal() {
        ...
        // Custom actions that WE assign to the notifications categories. Better off creating an enum. It's like setting a notif. channel in Android
        notificationContent.categoryIdentifier = "alarm"
        notificationContent.userInfo = ["customData": "fizzbuzz"] // Custom data with whatever we want to put. It's like putting an extra on an Intent in Android.
    ...
    func registerAlarmCategory() {
        ...
        // Challenge 2 of instructor
        let reminder = UNNotificationAction(identifier: "reminder", title: "Remind me in a day", options: .foreground)
        // intentIdentifiers is used to connect the notifications to intents. options allows us, for example, to allow carplay support
