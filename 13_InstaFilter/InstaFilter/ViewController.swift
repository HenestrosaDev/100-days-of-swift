...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func changeFilter(_ sender: UIButton) {
        let filters = ["CIBumpDistortion", "CIGaussianBlur", "CIPixellate", "CISepiaTone", "CITwirlDistortion", "CIVignette", "CIUnsharpMask"]
    ...
    @IBAction func save(_ sender: Any) {
        if let image = imageView.image {
            ...
            showAlertController("Error", "There is no image to save. Click the \"add\" button from the upper right corner")
        }
    }
    ...
    /**
     Some filters doesn't support the intensity value of the slider, so we need to access its inputKeys and to check if it contains compatible keys with the intensity value. It's not within a switch statement because some filters use multiple keys
     */
