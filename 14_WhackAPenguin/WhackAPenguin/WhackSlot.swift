...
class WhackSlot: SKNode {
    ...
    func configure(at position: CGPoint) {
        ...
        //A crop node uses an image as a cropping mask: Anything in the colored part will be visible, anything in the transparent part will be invisible. We need to crop the penguin in order to give the impression that they are inside the holes. The mask is shaped like the hole. When the penguin moves outside the mask, the penguin will be invisible.
        ...
        //We need to add the penguinNode to the cropNode because the cropNode  only crops nodes that are inside it. The hierarchy goes like this: Root view -> Slot -> Hole & (Crop -> Penguin)
    ...
    func show(hideTime: Double) {
        ...
        //The 3.5 is completely arbitary. The lesser the number, the faster will disappear and allow his hole to be vacant.
