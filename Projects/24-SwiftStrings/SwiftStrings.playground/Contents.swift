...
extension String {
    /**
     subscript is a shortcut to elements of a collection, list, or sequence.
     i.e.:
     var array = ["Antoine", "Jaap", "Lady"];
     print(array[0]);
     The subscript always goes between []
     */
...
print("be lkmlkÑñ9ml mfyes".isNumeric)
