...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        /**
         This indicates AutoLayout that, in case of having to stretch something, this will have top
         priority for getting stretched
         */
        ...
        // Same as enabled = false in Android. The user won't be able to type on it.
    ...
    @objc func submitTapped(_ sender: UIButton) {
        ...
        /**
         Tries to find the index of the solution that the user typed.
         If the answer matchs a solution using firstIndex(), then:
         */
        if let solutionPosition = solutions.firstIndex(of: answerText) {
            ...
            /**
             This checks whether we completed the level or not. We can only get 7 points por level,
             so if we have 7 points and then them by 7, the module of the division=0.
             */
            if answersNumber == 7 {
                showAlert(
                    title: "Well done",
            ...
            showAlert(
                title: "Incorrect",
                message: "\(answerText) is not a valid answer",
                isLevelUp: false
            )
        }
    }
