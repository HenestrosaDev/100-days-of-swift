...
enum SequenceType: CaseIterable {
    case oneNoBomb, // One penguin showing (no bombs)
         ...
         four,
         /**
          Enemy chains don't wait until the previous enemy is offscreen before creating a new one,
          so it's like throwing five enemies quickly but with a small delay between each one.
          */
         chain,
         fastChain,
         fastEnemy
