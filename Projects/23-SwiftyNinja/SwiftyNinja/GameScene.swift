...
class GameScene: SKScene {
    ...
    func endGame(triggeredByBomb: Bool) {
        ...
        isGameEnded = true
        // This line is commented to let the nodes die instead
        // physicsWorld.speed = 0
        
        // This line is commented to keep interaction enabled for new game button
        ...
        showGameOver() // Challenge 3 of instructor
        showNewGameOption() // Bonus: new game
    }
