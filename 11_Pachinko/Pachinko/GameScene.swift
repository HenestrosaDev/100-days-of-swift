...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        //Blend modes determine how a node is drawn. .replace means "draw the background ignoring any alpha values"
    ...
    func makeObstacle(location: CGPoint? = nil) {
        ...
        let obstacle = SKSpriteNode(color: UIColor(red: CGFloat.random(in: 0...1), green: CGFloat.random(in: 0...1), blue: CGFloat.random(in: 0...1), alpha: 1), size: size)
    ...
    func makeBouncer(at position: CGPoint) {
        ...
        //isDynamic makes an object static (or not)
