...
//NSCoding is necessary for saving the people array to UserDefaults. Kind of Serializable in Android. It's backwards compatible with Objective-C, unlike the Codable protocol that does the same only for Swift. It's much more simpler.
